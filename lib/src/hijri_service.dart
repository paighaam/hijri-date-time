...
class _HijriService {
  ...
  _HijriService._(Map<int, int> adjustments) {
    _adjustments = adjustments;
  }

  factory _HijriService(AdjustmentConfiguration adjustmentConfiguration) {
    return _instances[adjustmentConfiguration.hashCode] ??=
        _HijriService._(adjustmentConfiguration.adjustments);
  }
  ...
  updateUmmAlQuraDataForIndia() {
    final newData = List<int>.from(_ummAlQuraDateArray);
    for (int i = 0; i < newData.length; i++) {
      newData[i] = newData[i] + 1;
    }

    _ummAlQuraDateArray = newData;
  }

  ///////////////////////////////
  // Add all the logic above this
  ///////////////////////////////

  List<int> _ummAlQuraDateArray = [
    28607,
    28636,
    28665,
    28695,
