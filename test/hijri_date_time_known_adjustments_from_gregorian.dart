...
void logHijriDebug(DateTime date, Map<int, int> adjustments) {
  final hijri = HijriDateTime.fromGregorian(date, adjustments: adjustments);
  final year = hijri.year;
  final month = hijri.month;
  final day = hijri.day;
  final iln = getILN(year, month);
  print(
      'Gregorian: \x1B[36m$date\x1B[0m => Hijri: $year-$month-$day, ILN: $iln, Adj: \x1B[33m${adjustments[iln]}\x1B[0m');
}
  ...
  group('Known Hijri Adjustments Tests', () {
    group('1424 AH Tests', () {
      test('1 Ramadan 1424 - With and Without Adjustment', () {
        ...
        logHijriDebug(dateWith, knownAdjustments);
